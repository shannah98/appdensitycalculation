...
Authors: Shannah Therese Aberin, Andrea Isabel Alcala, John Christopher Galleon, Janrey
...
## Step 1: Loading the dplyr library
...
## Step 2: Reading the needed CSV files
...
## Step 3: Calculating the number of barangay per region
...
```
## Step 4: Merging regiondata data frame and number of barangay per region
...
## Step 5: Calculating the average area of barangay per region
...
```
## Step 6: Combining the Region, Area, number of barangay per region, and the average area of barangay per region in a single data frame
...
## Step 7: Merging populationdata data frame and the data frame generated from previous step
...
```
## Step 8: Calculating the population density per barangay
...
## Step 9: Combining the data frame generated from the seventh step and the calculated population density from the previous step.
...
## Step 10: Sorting the final data frame in descending order
...
## Step 11: Displaying the top five rows from the output of the previous code
...
## Step 12: Displaying the final data frame
...
## Step 13: Saving the final output as comma separated values (CSV) file
